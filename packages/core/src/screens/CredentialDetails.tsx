...
//   }, [])
//
//   const onNFCTap = useCallback(() => {
//     closeOverflowMenu()
//   }, [closeOverflowMenu])
//
//   const onShareCredential = useCallback(() => {
//     closeOverflowMenu()
//   }, [closeOverflowMenu])
//
//   if (loading) {
...
//               })}
//             >
//               <Text style={{ color: '#FFFFFF', fontSize: 16 }}>Go to channel</Text>
//             </Pressable>
//
//             <Pressable
...
//               })}
//             >
//               <Text style={{ color: '#FFFFFF', fontSize: 16 }}>Remove credential</Text>
//             </Pressable>
//
//             <Pressable
//               onPress={onPresentQRCode}
//               accessibilityRole="button"
//               accessibilityLabel="Present QR code"
//               style={({ pressed }) => ({
//                 paddingHorizontal: 16,
//                 paddingVertical: 12,
//                 opacity: pressed ? 0.7 : 1,
//               })}
//             >
//               <Text style={{ color: '#FFFFFF', fontSize: 16 }}>Present QR code</Text>
//             </Pressable>
//
//             <Pressable
//               onPress={onNFCTap}
...
//               })}
//             >
//               <Text style={{ color: '#FFFFFF', fontSize: 16 }}>NFC Tap</Text>
//             </Pressable>
//
//             <Pressable
...
//               })}
//             >
//               <Text style={{ color: '#FFFFFF', fontSize: 16 }}>Share credential</Text>
//             </Pressable>
//           </View>
//         </View>
//       </Pressable>
...
//             <Text style={styles.removeModalTitle}>Remove Credential</Text>
//             <Text style={styles.removeModalMessage}>
//               Are you sure you wish to remove this credential? This action cannot be undone.
//             </Text>
//             <View style={styles.removeModalButtons}>
//               <TouchableOpacity style={styles.removeModalCancelButton} onPress={cancelRemoveCredential}>
//                 <Text style={styles.removeModalCancelButtonText}>BACK</Text>
//               </TouchableOpacity>
//               <TouchableOpacity style={styles.removeModalConfirmButton} onPress={confirmRemoveCredential}>
//                 <Text style={styles.removeModalConfirmButtonText}>REMOVE CREDENTIAL</Text>
//               </TouchableOpacity>
//             </View>
//           </View>
//         </View>
